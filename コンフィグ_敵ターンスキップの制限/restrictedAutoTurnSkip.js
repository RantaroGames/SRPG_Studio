...
※細かい挙動
本プラグインで制限するターンスキップは、ターンを丸ごとスキップするものを指します
戦闘が発生し、戦闘アニメーションや戦闘時会話などのイベントは、通常通りスキップすることが可能です
...
■既知の不具合
敵ターンスキップを「早送り」にしている場合であっても、一定の条件で早送りが解除される場合がある
(死亡台詞のイベントが発生した後などに早送りが解除される場合がある)
